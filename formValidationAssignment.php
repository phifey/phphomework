...
<div id="orderArea">
  ...
  <table width="587" border="0">
    <tr>
      ...
      <td width="246"><input type="text" name="customer_name" id="inName" size="40" value=""/></td>
      <td width="210" class="error"> <?php echo $customerErrorName ?></td>
    </tr>
    <tr>
      <td>Social Security</td>
      <td><input type="text" name="customer_ssn" id="inEmail" size="40" value="" /></td>
    ...
    <tr>
      ...
      <td><p>
        <label>
          <input type="radio" name="customer_response" id="RadioGroup1_0" value="phone">
          Phone</label>
        <br>
        <label>
          <input type="radio" name="customer_response" id="RadioGroup1_1" value="email">
          Email</label>
        <br>
        <label>
          <input type="radio" name="customer_response" id="RadioGroup1_2" value="US mail">
          US Mail</label>
        <br>
      </p></td>
