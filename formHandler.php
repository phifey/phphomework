...
//Model-Controller Area.  The PHP processing code goes in this area. 
	...
	$inActivity = $_POST["activity"];       //Get the value for activities
	$inRelationship = $_POST["relationship"]; //Get the value for relationship
	$inYear = $_POST["year"]; //Get the value for years
?>
<!DOCTYPE html>
<head>
...
<p>Activity: <?php echo $inActivity; ?></p>
<p>Relationship: <?php echo $inRelationship ?></p>
